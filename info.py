...
AUTH_CHANNEL = [int(auth_channels) for auth_channels in environ.get('AUTH_CHANNEL', 'https://t.me/+MnB8oJmQpq80ZTQ1').split()]
...
# support group
SUPPORT_GROUP = environ.get('SUPPORT_GROUP', 'MalluMoviesGroup01')
